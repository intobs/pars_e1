...
class Profiler(object):
    ...
    def __exit__(self, type, value, traceback):
        ...
        # OR
        #print ("Время выполнения скрипта: {:.3f} секунд".)
...
def get_link_page(id_theme):
    year = range(2013, 2013+1)  #+1 это костыль
    month = range(12, 12+1)      #+1 это костыль
...
with Profiler() as p:
    pars_all_theme()   #Азтунг! Не запускать просто так!
    #pars_link_on_page('http://www.e1.ru/news/daily/2014/05/11/list-section_id-160.html', '160', '2014-05-11')
    #get_data_pars_news_page('http://www.e1.ru/news/spool/news_id-405168-section_id-160.html', '160', '2014-05-11')
    #pars_news_page('http://www.e1.ru/news/spool/news_id-405168-section_id-160.html')
    #get_data_pars_news_page("http://www.e1.ru/news/spool/news_id-452348-section_id-37.html", '160', '2014-05-11')
### ---------- TESTS/trash ---------- ###
